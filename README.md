# Home Assistant (0.107.7) configuration
This is my primary [Home Assistant](https://home-assistant.io/) Core configuration, This instance is running 0.107.7 on a VM, using an old laptop (Intel Core i5-3230M), with a manual Python virtual environment install (aka Home Assistant Core) [following this guide](https://home-assistant.io/docs/installation/raspberry-pi/).
